...
const store = multer({ storage }) // same as in TM
...
// I NEED A SERIOUS REFRESHER ON ROUTES. 
...
// DID WE ALREADY WALK THROUGH "GET" IN THE VIDEO? I think openDownloadStream is deprecated ---NOPE. 
